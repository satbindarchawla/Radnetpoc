/*
* ***************************************************************************************************************************
* LWC Component Name - DH_goLiveCalendar
* 
...
import getRegion from '@salesforce/apex/DH_GoLiveCalendarController.getRegion';
import getgoLiveDate from '@salesforce/apex/DH_GoLiveCalendarController.getgoLiveDate';
import getEventRecords from '@salesforce/apex/DH_GoLiveCalendarController.getEventRecords';
import getRelatedFilesByRecordId from '@salesforce/apex/DH_GoLiveCalendarController.getRelatedFilesByRecordId';
import createEvent from '@salesforce/apex/DH_GoLiveCalendarController.createEvent';
import hasPermissionSet from '@salesforce/apex/DH_GoLiveCalendarController.hasPermissionSet';
...
export default class DH_goLiveCalendar extends NavigationMixin(LightningElement) {
    ...
    */
    ...
    handlePreviewImage(event) {
        ...
        getRelatedFilesByRecordId({ recordId: recordIdimg })
            .then((data) => {
                const ImageId = data.contentDocId;
                const publicLink = data.publicUrl;
                if (this.isGuestUser) {
